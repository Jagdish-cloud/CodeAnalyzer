...
export default function NewsletterPage() {
  ...
  const handleView = (newsletter: Newsletter) => {
    ...
    link.href = `/uploads/${newsletter.filePath.split('/').pop()}`;
    link.target = '_blank';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Manage newsletter publications and documents for your institution.
          </p>
        </div>
            ...
            {newsletters.length === 0 ? (
              <div className="p-12 text-center">
                ...
                <p className="text-gray-500 mb-6">
                  No newsletters have been uploaded yet. Create your first newsletter.
                </p>
                <Link href="/add-newsletter">
              ...
              <Table>
                <TableHeader>
                  <TableRow className="border-white/20">
                    <TableHead className="font-semibold text-gray-700">Topic Name</TableHead>
                ...
                <TableBody>
                  {newsletters.map((newsletter) => (
                    <TableRow key={newsletter.id} className="border-white/20 hover:bg-white/30 transition-colors">
                      ...
                      <TableCell>
                        <div className="flex items-center justify-center gap-2">
                          ...
                          <Link href={`/edit-newsletter/${newsletter.id}`}>
                            <Button
                              variant="outline"
                              size="sm"
