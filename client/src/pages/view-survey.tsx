      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 p-6">
        <div className="max-w-4xl mx-auto">
          <div className="text-center py-12">
            <h1 className="text-2xl font-bold text-gray-600">Survey Not Found</h1>
            <Link href="/surveys">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-4 text-sm text-gray-600">
            ...
            <span>{survey?.choices?.length || 0} Total Choices</span>
          </div>
        </div>
        ...
        <div className="space-y-4">
          {survey?.questions && survey.questions.length > 0 ? (
            survey.questions.map((question, questionIndex) => {
              ...
              const questionChoices = survey?.choices?.filter(choice => 
                choice.questionId === question.id || choice.id?.startsWith(`${question.id}-`)
              ) || [];
              
              const surveyType = question.surveyType || "Single Choice";
            ...
            <div className="text-center py-8">
              <p className="text-gray-500">No questions found in this survey.</p>
            </div>
          )}
        </div>
