...
export default function AddBusRoutePage() {
  ...
  const [mapCenter, setMapCenter] = useState({
    lat: 12.907974564043526,
    lng: 77.57370469559991,
  });
  ...
  const onSubmit = (values: FormValues) => {
    if (stops.length < 2) {
      toast({
        ...
        description:
          "Please select at least 2 stops to create a route (starting and ending locations).",
        variant: "destructive",
      });
      return;
    }
  ...
  const handleMapClick = (event: any) => {
    ...
    if (event && event.detail && event.detail.latLng) {
      ...
      setSelectedLocation({
        lat,
        lng,
        address: "🔄 Getting location address...",
      });
      ...
      geocoder.geocode({ location: { lat, lng } }, (results, status) => {
        ...
        if (status === "OK" && results && results[0]) {
          ...
          toast({
            ...
            description:
              "Using coordinates instead. Location will still work correctly.",
            variant: "destructive",
          });
        }
      });
  ...
  const handleSelectLocation = () => {
    if (selectedLocation && pickupTime) {
      ...
      toast({
        title: "Stop Added",
        description:
          "Location and pickup time have been added to the route stops.",
      });
    } else {
      toast({
        title: "Missing Information",
        description:
          "Please select a location and pickup time before adding the stop.",
        variant: "destructive",
      });
    }
  };
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Create a new bus route with stops, vehicle details, and staff
            assignments.
          </p>
        </div>
                  ...
                  <div className="bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200 rounded-lg p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      ...
                      <div className="bg-white/60 rounded-lg p-4">
                        ...
                        <p className="text-sm text-gray-700">
                          {stops[stops.length - 1]?.address || "Not selected"}
                        </p>
                      </div>
                      <div className="bg-white/60 rounded-lg p-4">
                        <h4 className="font-medium text-blue-700 mb-2">
                        ...
                        <p className="text-sm text-gray-700">
                          {form.watch("routeNumber")
                            ? `BUS-${form.watch("routeNumber")}`
                            : "Will generate after route number"}
                        </p>
                      </div>
                    </div>
                    <div className="mt-4 bg-white/60 rounded-lg p-4">
                      ...
                      <p className="text-sm text-gray-700">
                        {stops.length} locations selected
                      </p>
                    </div>
                  </div>
                )}
                      ...
                      <DialogContent className="max-w-4xl max-h-[85vh] overflow-hidden">
                        <DialogHeader className="flex-shrink-0">
                          ...
                          <p className="text-sm text-gray-600 mt-2">
                            🎯 <strong>Drag the map</strong> to navigate,{" "}
                            <strong>click to select a location</strong>, then{" "}
                            <strong>drag the marker</strong> to fine-tune the
                            position, or use the optional search bar below
                          </p>
                        </DialogHeader>
                        ...
                        <div className="space-y-4 overflow-y-auto max-h-[calc(85vh-120px)] pr-2 flex-1">
                          ...
                          <div className="relative">
                                    ...
                                    <Marker
                                      ...
                                      onDragEnd={(e) => {
                                        ...
                                        if (e.latLng) {
                                          ...
                                          console.log("Drag end coordinates:", {
                                            lat,
                                            lng,
                                          });
                            ...
                            <div className="absolute top-2 left-2 bg-white/90 backdrop-blur-sm rounded-lg p-2 shadow-sm">
                              <p className="text-xs text-gray-600">
                                🗺️ Drag map to navigate • 📍 Click to select •
                          ...
                          {selectedLocation && (
                            <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-lg p-4 w-full">
                              ...
                              <p className="text-sm text-green-700 mb-3 leading-relaxed break-words">
